...
createPiece = function( x , y, size )
	...
	piece.label =  display.newText( "", 0, 0, native.systemFont, 120 ) -- Creates label empty for now, eventually will be X or O
...
----------------------------------------------------------------------
	...
	currentTurnMsg = display.newText( "Current Turn: " .. currentTurn , 0, 0, native.systemFont, 80 )
	...
	gameStatusMsg = display.newText( "No winner yet..." , 0, 0, native.systemFont, 80 )
	...
	resetGameButtonText =  display.newText( "Reset Game", 0, 0, native.systemFont, 80 )
